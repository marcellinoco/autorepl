  ...
  */
  ...
  export interface DummyDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     *     
    **/
    createMany<T extends DummyCreateManyArgs<ExtArgs>>(
     ...
     * 
    **/
    createManyAndReturn<T extends DummyCreateManyAndReturnArgs<ExtArgs>>(
      args?: SelectSubset<T, DummyCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$DummyPayload<ExtArgs>, T, 'createManyAndReturn'>>
